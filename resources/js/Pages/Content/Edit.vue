        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div  class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    Güncelle: {{ props.content.name }}
                </h1>
            </div>

            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <Link :href="route('contents.index',{contentType:props.content_type.id,language:props.content.language})" class="btn fw-bold btn-sm btn-secondary d-flex align-items-center">
            ...
            <form @submit.prevent="update">
                ...
                <div class="row g-4 g-lg-6 g-xl-10" v-if="!props.depending_contents || form.depending_content_id">
                    <div class="col-lg-9">
                        ...
                        <ContentArea 
                            :form="form" 
                            :use-sections="!props.content_type.offcanvas" 
                            :add-section="props.content_type.offcanvas && form.content.length == 0" 
                            :layout-mode="true" 
                        ...
                        <div class="card mb-4 mb-xl-10" v-if="props.content_type.has_url">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    <label class="col-md-6 fw-bold text-uppercase">HEADER ŞABLON</label>
                                    <div class="col-md-6">
...
const form = useForm({
    ...
    additional:{
        footerScripts:props.content && props.content.additional && props.content.additional.footerScripts ? props.content.additional.footerScripts : ``,
        headerScripts:props.content && props.content.additional && props.content.additional.headerScripts ? props.content.additional.headerScripts : ``,
        hideHeader:props.content ? props.content.additional && props.content.additional.hideHeader : false,
        customTitle:props.content ? props.content.additional && props.content.additional.customTitle : false,
        customTitleText:props.content ? props.content.additional && props.content.additional.customTitleText : null,
        subTitle:props.content ? props.content.additional && props.content.additional.subTitle : null,
        hideFromWidgets:props.content ? props.content.additional && props.content.additional.hideFromWidgets : false,
        icon:props.content?.additional?.icon ?? ""
    },
    content_categories:props.content.content_categories.length ? props.content.content_categories.map((row) => row.id) : [],
    attributes:props.content_attributes,
    media_objects:{
        mainImage:props.content.media_objects.mainImage,
        headerImage:props.content.media_objects.headerImage,
        mainVideo:props.content.media_objects.mainVideo,
        galleryImages:props.content.media_objects.galleryImages,
    },
    seo:{
        title:props.content.seo ? props.content.seo.title : "",
        description:props.content.seo ? props.content.seo.description : ""
    },
    content:props.content.content ?? [],
    is_published:props.content.is_published,
    parent_id:props.content.parent_id,
    slider_id:props.content.slider_id,
    layout_id:props.content.layout_id ?? props.content_type.layout_id,
    header_layout_id:props.content.header_layout_id,
    tags:props.content.tags.length ? props.content.tags.map((row) => row.id) : [],
    start_date:new Date(props.content.start_date),
    depending_content_id:props.content.depending_content_id,
...
const update = () => {
    form.put(route('contents.update', [props.content.id,{language:props.content.language}]),{
        only:['content','flash','errors'],
        onSuccess: () => {
...
const getTags = () => {
    fetch(route('tags.index',{language:props.content.language}),{
       headers: {
