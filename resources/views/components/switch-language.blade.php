...
<div x-data="{ open: false }" class="relative inline-block">
    ...
    <div x-show="open" x-transition.opacity @click.away="open = false"
        ...
        <div class="flex flex-col items-center bg-transparent py-2 space-y-2">
            @foreach (config('languages.active') as $lang)
                ...
                class="hover:scale-110 transition-transform  inline-flex items-center gap-2 px-2 py-1 pt-2 rounded-md bg-transparent ">
